...
public class AuthenticationHandler implements Authenticator, Interceptor {
    ...
    public AuthenticationHandler(StudyUserCredentials studyUserCredentials,
    ...
    private okhttp3.Request addBridgeHeaders(okhttp3.Request request) {
        ...
        String sessionToken = session == null ? "" : session.getSessionToken();
    ...
    public String getSessionToken() {
        Session session = sessionAtomicReference.get();
        return session == null ? "" : session.getSessionToken();
    }
}
