...
public final class Schedule {
    ...
    public boolean equals(Object obj) {
        ...
        return (Objects.equals(activities, other.activities) && Objects.equals(cronTrigger, other.cronTrigger) &&
                Objects.equals(endsOn, other.endsOn) && Objects.equals(expires, other.expires) && Objects.equals(label, other.label) &&
                Objects.equals(scheduleType, other.scheduleType) && Objects.equals(startsOn, other.startsOn) &&
                Objects.equals(eventId, other.eventId) && Objects.equals(delay, other.delay) && Objects.equals(interval, other.interval) &&
    ...
    public String toString() {
        return String.format(
                "Schedule [label=%s, scheduleType=%s, cronTrigger=%s, startsOn=%s, endsOn=%s, expires=%s, eventId=%s, delay=%s, " +
                        "interval=%s, times=%s, persistent=%s, activities=%s]",
                label,
                scheduleType,
                cronTrigger,
                startsOn,
